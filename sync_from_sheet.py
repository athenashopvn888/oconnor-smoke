"""
OCONNOR SMOKE - Auto Sync from Google Sheets
==========================================
...
a filtered menu for OCONNOR SMOKE (ALC01).
...
def main():
    print("=" * 60)
    print(f"  OCONNOR SMOKE - Product Sync (Store: {STORE_CODE})")
    print("=" * 60)
    print()
    ...
    if do_deploy:
        ...
        if result.returncode == 0:
            print("  [OK] Live at https://oconnorsmokecannabis.com")
        else:
            print(f"  Output:\n{result.stdout[-500:]}")
    else:
