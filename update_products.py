"""
OCONNOR SMOKE — Product Update Script
===================================
Drop your ONHAND CSV into the oconnor-smoke folder as "onhand.csv" and run:
...
def main():
    ...
    if not os.path.exists(csv_path):
        print("=" * 60)
        print("  OCONNOR SMOKE — Product Updater")
        print("=" * 60)
        print()
    ...
    if ans in ("y", "yes"):
        ...
        print("\n  [OK] Deployed! Check https://oconnorsmokecannabis.com")
    else:
