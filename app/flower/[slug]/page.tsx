...
function getJsonLd(flower: FlowerProduct) {
  ...
  const offers: any = {
    "@type": "Offer",
    url: `https://oconnorsmokecannabis.com/flower/${flower.slug}`,
    priceCurrency: "CAD",
    availability: "https://schema.org/InStock",
    itemCondition: "https://schema.org/NewCondition",
    seller: { "@type": "Organization", name: "OCONNOR SMOKE" },
  ...
  return {
    ...
    "@type": "Product",
    name: flower.name,
    image: flower.image ? [flower.image.startsWith('http') ? flower.image : `https://oconnorsmokecannabis.com${flower.image.startsWith('/') ? '' : '/'}${flower.image}`] : undefined,
    description: strainData.description,
    brand: { "@type": "Brand", name: "OCONNOR SMOKE" },
    ...
    "itemListElement": [
      {
        ...
        "position": 1,
        "name": "Home",
        "item": "https://oconnorsmokecannabis.com"
      },
      {
        "@type": "ListItem",
        "position": 2,
        "name": tierName,
        "item": `https://oconnorsmokecannabis.com/${tierSlug}`
      },
      {
        "@type": "ListItem",
        "position": 3,
        "name": flower.name,
        "item": `https://oconnorsmokecannabis.com/flower/${flower.slug}`
      }
    ]
  };
}
