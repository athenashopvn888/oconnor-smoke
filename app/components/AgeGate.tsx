...
export default function AgeGate() {
  ...
  useEffect(() => {
    ...
    const verified = localStorage.getItem("OSC01_age_verified");
    if (verified !== "true") {
      setShow(true);
    }
  }, []);
  ...
  const handleVerify = () => {
    localStorage.setItem("OSC01_age_verified", "true");
    setShow(false);
  };
      ...
      <div className={styles.modal}>
        {underage ? (
          ...
          <div className={styles.promptState}>
            ...
            <p className={styles.text}>
              OCONNOR SMOKE requires all visitors to be of legal age.
