...
const LOCAL_FAQS = [
  {
    ...
    a: "OCONNOR SMOKE at 132 O'Connor Dr Unit B, GTA is Open 24 Hours a day, 7 days a week. Walk in anytime — no appointment needed.",
  },
  {
      ...
      <section className={styles.seoSection}>
        <div className={styles.container}>
          <div className={styles.seoPanel}>
            <h2 className={styles.seoPanelTitle}>132 O'Connor Dr Unit B & Nearby Expressway's Premier Cannabis Dispensary — Open 24 Hours</h2>
            <p className={styles.seoPanelText}>
              Welcome to <strong>OCONNOR SMOKE</strong>, GTA's premier 24-hour cannabis destination at 132 O'Connor Dr Unit B. We carry an electrifying selection of top-shelf strains around the clock — from ultra-rare exotics to solid everyday budget picks.
            </p>
            <p className={styles.seoPanelText}>
              Open 24 hours, 7 days a week — OCONNOR SMOKE never closes. Our live menu is constantly refreshed with the freshest drops, premium prerolls, artisan edibles, and everything in between. Whether you're winding down after a late shift or stocking up for the weekend, our knowledgeable staff is always here for you.
            </p>
            <p className={styles.seoPanelText}>
              Searching for a cannabis dispensary in GTA or the surrounding area? OCONNOR SMOKE is your 24-hour destination for premium flower, potent prerolls, and artisan edibles. Our six-tier pricing system means quality cannabis at every budget level — starting from just $3/g.
            </p>
          </div>
        </div>
      </section>
