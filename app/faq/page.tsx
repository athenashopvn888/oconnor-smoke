...
export const metadata: Metadata = {
  title: "FAQ — OCONNOR SMOKE | GTA Dispensary Questions",
  description:
    "Frequently asked questions about OCONNOR SMOKE in GTA. Hours, location, products, pricing, bundle offers, and everything you need to know before visiting.",
  alternates: {
...
const FAQ_CATEGORIES = [
  {
    ...
    faqs: [
      { q: "Where is OCONNOR SMOKE located?", a: "We are located at 132 O'Connor Dr Unit B, GTA, ON M4J 2S4. We're easily accessible by TTC bus routes and close to major highways like the 401." },
      { q: "What are your hours?", a: "We are open daily from 10:00 AM to 12:00 AM (midnight). Walk in anytime — no appointment needed." },
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "Do you have a live menu?", a: "Yes! Our online menu at oconnorsmokecannabis.com updates in real time with current stock, prices, THC levels, and availability. You can check what's in stock before you visit." },
  ...
  },
  {
    ...
    faqs: [
      { q: "Do I need an appointment?", a: "No! OCONNOR SMOKE is walk-in only. Just show up anytime — we are open daily from 10:00 AM to 12:00 AM (midnight)." },
      ...
      <main className={styles.main}>
        ...
        <section style={{ width: "100%", overflow: "hidden", marginTop: "92px" }}>
          <img
            ...
            alt="OCONNOR SMOKE FAQ — Your Questions Answered"
        ...
        <div className={styles.content}>
          ...
          <p className={styles.pageSubtitle}>
            Everything you need to know about OCONNOR SMOKE — GTA&apos;s premium dispensary at 132 O'Connor Dr Unit B in GTA.
          </p>
