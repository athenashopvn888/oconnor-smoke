...
export const CATEGORY_CONFIG: Record<string, CategoryInfo> = {
  EDIBLES: {
    ...
    faqs: [
      ...
      { q: "Can I buy edibles at OCONNOR SMOKE?", a: "Yes! Visit us at 132 O'Connor Dr Unit B, GTA. We're open daily from 10:00 AM to 3:00 AM with a full edibles selection in store." },
    ],
  },
  "VAPE PENS": {
  ...
  CIGARETTES: {
    ...
    seoDescription: "OCONNOR SMOKE is your go-to source for affordable native cigarettes in GTA. We carry a wide selection of premium and value tobacco brands at competitive prices. Located at 132 O'Connor Dr Unit B in the heart of 132 O'Connor Dr Unit B & Nearby Expressway, we're Open Daily: 10:00 AM - 3:00 AM.",
    faqs: [
