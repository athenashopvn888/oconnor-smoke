...
export const CATEGORY_CONFIG: Record<string, CategoryInfo> = {
  ...
  "VAPE DISPOSABLE": {
    ...
    seoTitle: "Disposable Vapes East York — THC Disposable Pens",
    seoIntro: "THC disposable vapes available at OCONNOR SMOKE, East York. No charging, no refilling — just open and enjoy.",
    seoDescription: "Disposable THC vapes are the easiest way to enjoy cannabis on the go. OCONNOR SMOKE stocks a wide selection of pre-charged, pre-filled disposable vape pens with various strain profiles and potencies. Perfect for beginners and experienced users alike. Visit us at 132 O'Connor Dr Unit B, East York.",
    faqs: [
  ...
  "ADD ONS": {
    ...
    seoTitle: "Cannabis Accessories East York — Grinders, Papers, Lighters & More",
    seoIntro: "Essential cannabis accessories at OCONNOR SMOKE, East York. Grinders, rolling papers, lighters, trays, and more.",
    seoDescription: "OCONNOR SMOKE carries all the accessories you need for the perfect smoke session. From premium grinders and rolling papers to lighters, trays, and storage containers, we have everything in stock. Visit us at 132 O'Connor Dr Unit B, East York.",
    faqs: [
  ...
  CIGARETTES: {
    ...
    faqs: [
      ...
      { q: "Where can I check cigarette prices?", a: "Use the current category grid. Posted brands and prices can change." },
    ],
  },
};
