...
export async function fetchLiveProducts(): Promise<{
  ...
  try {
    const res = await fetch(`${APPS_SCRIPT_URL}?store=OSC01`, {
...
export const CATEGORY_CONFIG: Record<string, CategoryInfo> = {
  EDIBLES: {
    ...
    seoIntro: "Browse the full cannabis edibles menu at OCONNOR SMOKE on GTA St, GTA. We carry THC gummies, chocolates, drinks, and more from top Canadian brands.",
    seoDescription: "Looking for cannabis edibles in GTA? OCONNOR SMOKE stocks a wide range of THC-infused gummies, chocolates, beverages, and baked goods. Our edibles range from micro-dose options for beginners to high-potency products for experienced consumers. All products are lab-tested and sourced from licensed Canadian producers. Visit us at 132 O'Connor Dr Unit B — we are Open Daily: 10:00 AM - 12:00 AM.",
    faqs: [
      ...
      { q: "Can I buy edibles at OCONNOR SMOKE?", a: "Yes! Visit us at 132 O'Connor Dr Unit B, GTA. We're open daily from 10:00 AM to 12:00 AM (midnight) with a full edibles selection in store." },
    ],
  },
  "VAPE PENS": {
    ...
    seoIntro: "Shop THC and nicotine vape pens at OCONNOR SMOKE, GTA. Cartridges, 510-thread batteries, and premium vape brands — all in stock.",
    seoDescription: "OCONNOR SMOKE carries a curated selection of vape pens and cartridges in GTA. From 510-thread THC cartridges to nicotine vape pods, we stock the most popular brands and flavours. Our knowledgeable budtenders can help you choose the right cartridge and battery setup. Visit us at 132 O'Connor Dr Unit B for the best vape selection in ByWard Market.",
    faqs: [
  ...
  "VAPE DISPOSABLE": {
    ...
    seoIntro: "THC disposable vapes available at OCONNOR SMOKE, GTA. No charging, no refilling — just open and enjoy.",
    seoDescription: "Disposable THC vapes are the easiest way to enjoy cannabis on the go. OCONNOR SMOKE stocks a wide selection of pre-charged, pre-filled disposable vape pens with various strain profiles and potencies. Perfect for beginners and experienced users alike. Visit us at 132 O'Connor Dr Unit B, GTA.",
    faqs: [
  ...
  CONCENTRATES: {
    ...
    seoIntro: "Premium cannabis concentrates at OCONNOR SMOKE, GTA. Shatter, wax, hash, live resin, and diamonds — all in stock.",
    seoDescription: "OCONNOR SMOKE offers a premium selection of cannabis concentrates in GTA. From traditional hash and kief to modern extracts like shatter, wax, live resin, and THC diamonds, we carry products for every preference and potency level. Our concentrates are sourced from trusted extractors and tested for purity. Visit us at 132 O'Connor Dr Unit B.",
    faqs: [
  ...
  PREROLLS: {
    ...
    seoIntro: "Pre-rolled cannabis joints at OCONNOR SMOKE, GTA. Singles, multi-packs, and infused pre-rolls — ready to light up.",
    seoDescription: "Skip the rolling and grab a pre-roll from OCONNOR SMOKE in GTA. We carry singles, multi-packs, and infused pre-rolls from premium flower. Whether you want a quick smoke or a party pack, our pre-roll selection has something for everyone. Visit us at 132 O'Connor Dr Unit B — we are Open Daily: 10:00 AM - 12:00 AM.",
    faqs: [
  ...
  "ADD ONS": {
    ...
    seoIntro: "Essential cannabis accessories at OCONNOR SMOKE, GTA. Grinders, rolling papers, lighters, trays, and more.",
    seoDescription: "OCONNOR SMOKE carries all the accessories you need for the perfect smoke session. From premium grinders and rolling papers to lighters, trays, and storage containers, we have everything in stock. Visit us at 132 O'Connor Dr Unit B, GTA.",
    faqs: [
  ...
  CIGARETTES: {
    ...
    seoTitle: "Native Cigarettes GTA — Discount Tobacco at OCONNOR SMOKE",
    seoIntro: "Discount native cigarettes at OCONNOR SMOKE, GTA. Premium and value brands at the best prices on GTA St.",
    seoDescription: "OCONNOR SMOKE is your go-to source for affordable native cigarettes in GTA. We carry a wide selection of premium and value tobacco brands at competitive prices. Located at 132 O'Connor Dr Unit B in the heart of 132 O'Connor Dr Unit B & Nearby Expressway, we're Open Daily: 10:00 AM - 12:00 AM.",
    faqs: [
