...
export const CATEGORY_CONFIG: Record<string, CategoryInfo> = {
  EDIBLES: {
    ...
    faqs: [
      ...
      { q: "Can I buy edibles at OCONNOR SMOKE?", a: "Yes! Visit us at 132 O'Connor Dr Unit B, GTA. We're open daily 24 hours with a full edibles selection in store." },
    ],
  },
  "VAPE PENS": {
  ...
  PREROLLS: {
    ...
    seoDescription: "Skip the rolling and grab a pre-roll from OCONNOR SMOKE in GTA. We carry singles, multi-packs, and infused pre-rolls from premium flower. Whether you want a quick smoke or a party pack, our pre-roll selection has something for everyone. Visit us at 132 O'Connor Dr Unit B — open daily 24 hours.",
    faqs: [
  ...
  CIGARETTES: {
    ...
    seoDescription: "OCONNOR SMOKE is your go-to source for affordable native cigarettes in GTA. We carry a wide selection of premium and value tobacco brands at competitive prices. Located at 132 O'Connor Dr Unit B in the heart of ByWard Market, we're open daily 24 hours. Stop by for the best cigarette prices in the neighbourhood.",
    faqs: [
