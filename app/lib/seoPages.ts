...
export const SEO_PAGES: SeoPageData[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: "East York Walk-In Counter", body: "The physical store is at 132 O’Connor Dr Unit B, East York, ON M4J 2S4. Check the current category page and call (437) 780-8378 when one product or size matters." },
    ],
    faqs: commonFaqs,
  },
  {
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: "Review Before You Travel", body: "Menu categories can rotate. Check the current page for the format you want and call (437) 780-8378 when a particular item is the reason for the trip." },
    ],
    faqs: commonFaqs,
  },
  {
    ...
    sections: [
      ...
      { heading: "Current Information", body: "Use the current menu for posted categories and call (437) 780-8378 for one-item confirmation. Product listings and prices can change." },
    ],
    faqs: commonFaqs,
  },
];
