...
export const STATIC_POSTS: StaticBlogPost[] = [
  {
    ...
    "title": "Is O'Connor Smoke the Right Weed Dispensary in Toronto for Your Visit?",
    "seoTitle": "O'Connor Smoke Weed Dispensary in Toronto | Visit Guide",
    "seo_title": "O'Connor Smoke Weed Dispensary in Toronto | Visit Guide",
    "metaDescription": "Plan a Toronto visit to O'Connor Smoke with store-page checks, menu categories, and practical next steps for adults 19+.",
    "meta_description": "Plan a Toronto visit to O'Connor Smoke with store-page checks, menu categories, and practical next steps for adults 19+.",
    "h1": "Is O'Connor Smoke the Right Weed Dispensary in Toronto for Your Visit?",
    "excerpt": "A practical Toronto visit guide for adults 19+ checking O'Connor Smoke.",
    "author": "Connor East",
  ...
  },
  {
    ...
    "title": "O'Connor Smoke Flower Guide: Budget, Premium and Exotic Sections",
    "seoTitle": "O'Connor Smoke Flower Guide | Toronto Budget to Exotic",
    "seo_title": "O'Connor Smoke Flower Guide | Toronto Budget to Exotic",
    "metaDescription": "Compare O'Connor Smoke flower sections including Budget, AA, AAA+, Premium, and Exotic with current-menu checks and natural value wording.",
    "meta_description": "Compare O'Connor Smoke flower sections including Budget, AA, AAA+, Premium, and Exotic with current-menu checks and natural value wording.",
    "h1": "O'Connor Smoke Flower Guide: Budget, Premium and Exotic Sections",
    "excerpt": "A clear flower guide for O'Connor Smoke, from cheap weed and budget weed searches to premium flower and exotic flower browsing.",
    "author": "Tess O.",
    "authorName": "Tess O.",
    "authorHandle": "@TessOConnor",
    "authorRole": "House Writer",
    ...
    "rewriteAction": "POLISHED PUBLIC COPY",
    "primaryKeyword": "O'Connor Smoke flower guide",
    "wordCount": 545
  },
  {
    "slug": "oconnor-smoke-local-visit-guide-2026",
    "oldTitle": "OCONNOR SMOKE Local Visit Guide for Adults 19+",
    "title": "O'Connor Smoke Menu Guide: Flower, Pre-Rolls, Edibles, THC Vapes and More",
    "seoTitle": "O'Connor Smoke Menu Guide | Toronto Weed Store Categories",
    "seo_title": "O'Connor Smoke Menu Guide | Toronto Weed Store Categories",
    "metaDescription": "Use this O'Connor Smoke menu guide to browse flower sections, pre-rolls, edibles, THC vapes, concentrates, accessories, and store details before visiting.",
    "meta_description": "Use this O'Connor Smoke menu guide to browse flower sections, pre-rolls, edibles, THC vapes, concentrates, accessories, and store details before visiting.",
    "h1": "O'Connor Smoke Menu Guide: Flower, Pre-Rolls, Edibles, THC Vapes and More",
    "excerpt": "A practical Toronto menu guide for O'Connor Smoke, with natural category paths for adults 19+.",
    "author": "Connor East",
    "authorName": "Connor East",
    "authorHandle": "@ConnorOnOConnor",
    "authorRole": "House Writer",
    ...
    "rewriteAction": "POLISHED PUBLIC COPY",
    "primaryKeyword": "O'Connor Smoke menu guide",
    "wordCount": 492
  }
];
