...
export const STATIC_POSTS: StaticBlogPost[] = [
  {
    ...
    title: "OCONNOR SMOKE Local Store Guide for Adults 19+",
    seoTitle: "OCONNOR SMOKE Guide | Toronto Adult 19+",
    seo_title: "OCONNOR SMOKE Guide | Toronto Adult 19+",
    metaDescription: "Adult 19+ guide to OCONNOR SMOKE around Oâ€™Connor / East York, with local store-page checks, menu-category context, and safe visit planning.",
    meta_description: "Adult 19+ guide to OCONNOR SMOKE around Oâ€™Connor / East York, with local store-page checks, menu-category context, and safe visit planning.",
    h1: "OCONNOR SMOKE Local Store Guide for Adults 19+",
    excerpt: "OCONNOR SMOKE guide for adults 19+ reviewing store information around Oâ€™Connor / East York.",
    author: "The OCONNOR SMOKE Team",
    date: "2026-07-02",
    category: "Store Guide",
    readTime: "4 min",
    content: `## OCONNOR SMOKE Local Store Guide for Adults 19+

OCONNOR SMOKE serves adults 19+ looking for store information around Oâ€™Connor / East York. Use this guide to get oriented, compare the store page with menu categories, and choose the most useful next step before visiting.
...
OCONNOR SMOKE is tied to O\\u2019Connor Drive and East York context in Toronto. Useful local content should make the page easier for shoppers to understand by connecting the store to nearby streets, neighbourhood language, and visit-planning details already supported by the site.
...
Start with the official OCONNOR SMOKE store page, then use the menu/category links to browse what the site makes easy to compare. Shoppers can confirm the right storefront, directions, contact options, and local visit details in one place.
...
### Is this guide for OCONNOR SMOKE only?

Yes. This guide is written for OCONNOR SMOKE and the local Toronto context connected to this website.
...
Open the store page, browse the available menu/category sections, and use the contact or directions options when you are ready to plan your visit.`,
    faq: "",
    internal_links_used: "[OCONNOR SMOKE Toronto store page](/weed-dispensary-toronto)\\n[OCONNOR SMOKE homepage](/)\\n[More OCONNOR SMOKE guides](/blog)",
    relatedLinks: [
      {
            "title": "OCONNOR SMOKE Toronto store page",
            "url": "https://oconnorsmokecannabis.com/weed-dispensary-toronto",
            "description": "Primary store-specific destination for current store details after reading the guide."
      },
      {
            "title": "OCONNOR SMOKE homepage",
            "url": "https://oconnorsmokecannabis.com/",
            "description": "Store-scoped general navigation for adults 19+."
      },
      {
            "title": "More OCONNOR SMOKE guides",
            "url": "https://oconnorsmokecannabis.com/blog",
  ...
  },
  {
    ...
    title: "O'Connor Smoke Price and Flower Tier Guide",
    seoTitle: "O'Connor Smoke Price Tier Guide",
    seo_title: "O'Connor Smoke Price Tier Guide",
    metaDescription: "O'Connor Smoke guide to flower tiers, weight choices, unit value, and store visit planning in Toronto.",
    meta_description: "O'Connor Smoke guide to flower tiers, weight choices, unit value, and store visit planning in Toronto.",
    h1: "O'Connor Smoke Price and Flower Tier Guide",
    excerpt: "A simple guide to O'Connor Smoke flower tiers, weights, and unit value.",
    author: "The O'Connor Smoke Team",
    date: "2026-07-09",
    category: "Price Guide",
    readTime: "4 min",
    content: `## O'Connor Smoke Price and Flower Tier Guide

O'Connor Smoke makes flower shopping easier by organizing the menu into clear tiers. Start with the tier that matches the kind of flower you want, then choose the weight that fits your budget and visit.
...
For the smoothest visit, open the O'Connor Smoke menu before heading out. The live menu is the best place to compare current flower tiers, weights, and store-specific options. The store page is also useful for directions, contact details, and visit planning.
...
- Open the O'Connor Smoke store page for directions, contact details, and visit planning.
...
Use the live menu for current store-specific selection, then use the store page for directions, contact details, and visit planning.`,
  ...
  },
  {
    ...
    title: "OCONNOR SMOKE Local Visit Guide for Adults 19+",
    seoTitle: "OCONNOR SMOKE Local Visit Guide | Toronto Adult 19+",
    seo_title: "OCONNOR SMOKE Local Visit Guide | Toronto Adult 19+",
    metaDescription: "Plan a visit to OCONNOR SMOKE in Toronto with adult 19+ store-page checks, menu-category paths, and local directions context.",
    meta_description: "Plan a visit to OCONNOR SMOKE in Toronto with adult 19+ store-page checks, menu-category paths, and local directions context.",
    h1: "OCONNOR SMOKE Local Visit Guide for Adults 19+",
    excerpt: "OCONNOR SMOKE guide for adults 19+ checking local context, store pages, and menu-category paths around O'Connor / East York.",
    author: "The OCONNOR SMOKE Team",
    date: "2026-07-09",
    category: "Local Guide",
    readTime: "5 min",
    content: `Use this guide to confirm the right OCONNOR SMOKE storefront around O'Connor / East York, understand nearby street context, and choose the most useful store page or menu path before visiting.

For current details, start with the official store page or contact staff before leaving.

## Confirm The Right Storefront

OCONNOR SMOKE is tied to O'Connor, East York, Toronto, nearby local roads. Local shoppers often compare several nearby search results, so the first job of this page is to make the store identity, area context, and next click easy to understand.
...
Searches near O'Connor / East York usually come from shoppers who already have a real-world route in mind. Mentioning nearby streets, neighbourhood language, and local travel context helps the page match how people actually search without inventing claims.
...
- Open the OCONNOR SMOKE store page: [https://www.oconnorsmokecannabis.com/weed-dispensary-toronto](https://www.oconnorsmokecannabis.com/weed-dispensary-toronto)
- Browse more local guides from the blog: [https://www.oconnorsmokecannabis.com/blog](https://www.oconnorsmokecannabis.com/blog)
- Confirm store-specific details before heading out.

## FAQ

### Is this guide only for OCONNOR SMOKE?

Yes. This page is written for OCONNOR SMOKE and the O'Connor / East York area.
...
Local shoppers search with neighbourhood and street language. Clear local context helps them confirm they are looking at the right store.`,
    ...
    internal_links_used: "/weed-dispensary-toronto, /blog, /blog/oconnor-smoke-local-visit-guide-2026",
    relatedLinks:     [
          {
                "title": "OCONNOR SMOKE store page",
                "url": "https://www.oconnorsmokecannabis.com/weed-dispensary-toronto",
                "description": "Official OCONNOR SMOKE page for local visit planning."
          },
          {
                "title": "OCONNOR SMOKE homepage",
                "url": "https://www.oconnorsmokecannabis.com/",
                "description": "Start from the OCONNOR SMOKE homepage."
          },
          {
                "title": "More OCONNOR SMOKE guides",
