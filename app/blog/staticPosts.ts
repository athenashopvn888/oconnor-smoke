...
export const STATIC_POSTS: StaticBlogPost[] = [
  {
    ...
    "title": "How to Plan a O'Connor Smoke Visit Without Guessing",
    "seoTitle": "O'Connor Smoke Visit Guide | Weed Dispensary in East York",
    "seo_title": "O'Connor Smoke Visit Guide | Weed Dispensary in East York",
    "metaDescription": "Plan a East York visit to O'Connor Smoke with a clear shopper checklist for store details, menu categories, current listings, and staff questions.",
    "meta_description": "Plan a East York visit to O'Connor Smoke with a clear shopper checklist for store details, menu categories, current listings, and staff questions.",
    "h1": "How to Plan a O'Connor Smoke Visit Without Guessing",
    "excerpt": "A practical visit guide for O'Connor Smoke, written for shoppers who want the next step without the runaround.",
    "author": "Connor East",
  ...
  },
  {
    ...
    "title": "How to Compare O'Connor Smoke Flower Without Guessing",
    "seoTitle": "O'Connor Smoke Flower Guide | Budget to Exotic",
    "seo_title": "O'Connor Smoke Flower Guide | Budget to Exotic",
    "metaDescription": "Compare O'Connor Smoke flower sections with natural guidance for cheap weed, budget weed, premium flower, exotic flower, and current menu checks.",
    "meta_description": "Compare O'Connor Smoke flower sections with natural guidance for cheap weed, budget weed, premium flower, exotic flower, and current menu checks.",
    "h1": "How to Compare O'Connor Smoke Flower Without Guessing",
    "excerpt": "A shopper-first flower guide for comparing Budget, AA, AAA+, Premium, and Exotic sections at O'Connor Smoke.",
    "author": "Tess O.",
    "authorName": "Tess O.",
    "authorHandle": "@TessOConnor",
    "authorRole": "House Writer",
  ...
  },
  {
    ...
    "title": "How to Shop the O'Connor Smoke Menu Like a Pro",
    "seoTitle": "O'Connor Smoke Menu Guide | East York Weed Store",
    "seo_title": "O'Connor Smoke Menu Guide | East York Weed Store",
    "metaDescription": "Shop the O'Connor Smoke menu with a simple shopper-first guide to flower, pre-rolls, edibles, THC vapes, concentrates, and current listings.",
    "meta_description": "Shop the O'Connor Smoke menu with a simple shopper-first guide to flower, pre-rolls, edibles, THC vapes, concentrates, and current listings.",
    "h1": "How to Shop the O'Connor Smoke Menu Like a Pro",
    "excerpt": "A natural guide to shopping the O'Connor Smoke menu without turning the visit into a guessing game.",
    "author": "Connor East",
    "authorName": "Connor East",
    "authorHandle": "@ConnorOnOConnor",
    "authorRole": "House Writer",
