...
const STATIC_POSTS = [
  ...
  },
  {
    ...
    title: "Why OCONNOR SMOKE is GTA's Best Dispensary",
...
export default function BlogContent() {
  ...
  useEffect(() => {
    fetch(`${APPS_SCRIPT_URL}?action=blog&store=OSC01`)
      .then((r) => r.json())
      ...
      <section className={styles.hero}>
        <div className={styles.heroInner}>
          <h1 className={styles.heroH1}>
            📝 OCONNOR SMOKE <span className={styles.heroAccent}>Blog</span>
          </h1>
